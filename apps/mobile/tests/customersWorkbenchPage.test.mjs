...
test('客户工作台页面展示客户核心字段并通过统计卡过滤', () => {
  ...
  assert.doesNotMatch(page, /customers-chip-row|customers-chip|v-for="tab in tabs"/);
});
...
test('客户工作台页面样式独立且不包含自动触达动作', () => {
  ...
  assert.match(css, /\.customer-clamped-text/);
